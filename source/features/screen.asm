...
.two_button_wait:
	...
	mov bl, 11110000b		; white on Black
	mov dh, 14
	mov dl, 27
	mov si, 8
	mov di, 15
	...
	mov bl, 00001111b		; Black on White for cancel button
	mov dh, 14
	mov dl, 42
	mov si, 9
	mov di, 15
...
.noleft:
	...
	mov bl, 11110000b		; White on Black for cancel button
	mov dh, 14
	mov dl, 43
	mov si, 8
	mov di, 15
