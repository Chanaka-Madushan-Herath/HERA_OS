...
os_main:
	...
	mov es, ax			; segments ever again, as HERA_OS and its programs
...
option_screen:
	...
	mov ax, dialog_string_1		; Ask if user wants hardware information or exit
	...
	os_init_msg		db ':::::::::::::::::::::::::: Welcome to HERA_OS ::::::::::::::::::::::::::::::::', 0
	os_version_msg		db 'Version ', HERA_OS_VER,'                                                     SE/2017/017', 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', HERA_OS_VER, 0

	dialog_string_1		db 'Welcome to HERA Operating System !!!!!!!!!', 0
	dialog_string_2		db 'Please select HDI for Hardware Information', 0
	dialog_string_3		db 'or select Exit for quit the OS.', 0
os_exit:
	mov ax, 5307h
	mov cx, 3
 	mov bx, 1
...
os_hardware:
	...
	strCPU 		db	"CPU Informations  ", 0x00
	strmemoryy		db	"Memory Information ", 0x00
	strport        	db	"Ports ", 0x00
